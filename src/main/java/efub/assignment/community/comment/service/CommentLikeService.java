...
//    }
    ...
    //컨트롤러 로직에 맞게 수정한 service
    @Transactional
    public String createCommentLike(Long commentId, Long memberId) {
        //1. 유효성검사
        Comment comment = commentService.commentValidation(commentId);
    ...
    - 해당 코멘트의 해당 사용자 좋아요 있는지 반환 : getCommentLikesPresent
     */
